...
append_js $sc_web_path/templates/components.html components/js/search_pharmacies_by_district_component/search_pharmacies_by_district_component.js
append_css $sc_web_path/templates/components.html components/css/search_pharmacies_by_district_component.css
