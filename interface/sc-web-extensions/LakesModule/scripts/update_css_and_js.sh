...
lakes_js_path=components/js/lakes/lakes.js
lakes_css_path=components/css/lakes.css
...
append_js $sc_web_path/templates/components.html $lakes_js_path
append_css $sc_web_path/templates/components.html $lakes_css_path
