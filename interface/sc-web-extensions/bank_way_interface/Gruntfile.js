module.exports = function(grunt) {
	...
	var wayDirPath = 'components/bank_way/';
    ...
    grunt.initConfig({
        concat: {
			...
			way: {
                src: [wayDirPath + 'src/bank_way-common.js',
                    wayDirPath + 'src/bank_way-component.js',
                    wayDirPath + 'src/bank_way-paintPanel.js'
                ],
                dest: wayDirPath + 'static/components/js/bank_way/bank_way.js'
            },
            html: {
        ...
        copy: {
			...
			wayJs: {
                cwd: wayDirPath + 'static/components/js/bank_way/',
                src: 'bank_way.js',
                dest: clientJsDirPath + 'bank_way/',
                expand: true,
                flatten: true
            },
            htmlJs: {
