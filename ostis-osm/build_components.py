...
def create_file(build_file, integrated):
    ...
    if integrated and config.get('component'):
    ...
    print("Write file: {}".format(target_file_path))
...
def build_component(descr, integrated):
    build_file = descr[1]
    print("Building {}".format(build_file))
...
def build(options):
    if options.all or options.component is None:
        ...
        if os.path.isfile(build_file):
            ...
            print("Error: Can't find {}".format(build_file))
