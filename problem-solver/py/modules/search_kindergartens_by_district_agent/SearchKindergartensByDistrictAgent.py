...
class SearchKindergartensByDistrictAgent(ScAgentClassic):
    def __init__(self):
        super().__init__("action_get_kindergartens_by_district")
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        self.logger.debug("SearchKindergartensByDistrictAgent starts")

        try:
            self.logger.debug("SearchKindergartensByDistrictAgent get arguments")
            ...
            self.logger.debug("SearchKindergartensByDistrictAgent ends")
    ...
    def find_kindergarten(self, kindergarten_district: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            self.logger.debug("SearchKindergartensByDistrictAgent get answer: " +
