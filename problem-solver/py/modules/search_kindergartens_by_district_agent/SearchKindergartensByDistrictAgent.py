...
class SearchKindergartensByDistrictAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        _logger.debug("SearchKindergartensByDistrictAgent starts")

        try:
            _logger.debug("SearchKindergartensByDistrictAgent get arguments")
            ...
            _logger.debug("SearchKindergartensByDistrictAgent ends")
    ...
    def find_kindergarten(self, kindergarten_district: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            _logger.debug("SearchKindergartensByDistrictAgent get answer: " +
