...
class SearchKindergartensByRegionAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        _logger.debug("SearchKindergartensByRegionAgent starts")

        try:
            _logger.debug("SearchKindergartensByRegionAgent get arguments")
            ...
            _logger.debug("SearchKindergartensByRegionAgent ends")
