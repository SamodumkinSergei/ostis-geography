...
class GetPharmaciesByLocationHouseNumberAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_pharmacies_by_location_house_number'],
                self.main_node,
            ...
            try:
                ...
                while pharmacyIterator.Next():
                    ...
                    NumberIterator= self.ctx.Iterator5(
                        ...
                        ScType.Unknown,
                        ScType.EdgeAccessConstPosPerm,
                        self.keynodes['nrel_location_house_number']
                    )
