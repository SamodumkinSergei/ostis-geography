...
class SearchKindergartensByStreetAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        self.logger.debug("SearchKindergartensByStreetAgent starts")

        try:
            self.logger.debug("SearchKindergartensByStreetAgent get arguments")
            ...
            self.logger.debug("SearchKindergartensByStreetAgent ends")
    ...
    def find_kindergarten(self, kindergarten_street: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            self.logger.debug("SearchKindergartensByStreetAgent get answer: " +
