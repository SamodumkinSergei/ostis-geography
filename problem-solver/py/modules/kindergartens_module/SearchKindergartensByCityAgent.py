...
class SearchKindergartensByCityAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        _logger.debug("SearchKindergartensByCityAgent starts")

        try:
            _logger.debug("SearchKindergartensByCityAgent get arguments")
            ...
            _logger.debug("SearchKindergartensByCityAgent ends")
    ...
    def find_kindergarten(self, kindergarten_city: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            _logger.debug("SearchKindergartensByCityAgent get answer: " +
