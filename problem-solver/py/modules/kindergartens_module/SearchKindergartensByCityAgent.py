...
class SearchKindergartensByCityAgent(ScAgentClassic):
    def __init__(self):
        super().__init__("action_get_kindergartens_by_city")
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        self.logger.debug("SearchKindergartensByCityAgent starts")

        try:
            self.logger.debug("SearchKindergartensByCityAgent get arguments")
            ...
            self.logger.debug("SearchKindergartensByCityAgent ends")
    ...
    def find_kindergarten(self, kindergarten_city: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            self.logger.debug("SearchKindergartensByCityAgent get answer: " +
