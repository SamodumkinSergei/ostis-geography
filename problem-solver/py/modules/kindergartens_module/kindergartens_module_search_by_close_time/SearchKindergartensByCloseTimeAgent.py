...
class SearchKindergartensByCloseTimeAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        _logger.debug("SearchKindergartensByCloseTimeAgent starts")

        try:
            _logger.debug("SearchKindergartensByCloseTimeAgent get arguments")
            ...
            _logger.debug("SearchKindergartensByCloseTimeAgent ends")
    ...
    def find_kindergarten(self, kindergarten_close_time: ScAddr, answer_node: ScAddr) -> None:
        ...
        kindergarten_template.triple_with_relation(
            ...
            self._keynodes["nrel_close_time"]
        )
        ...
        for item in result:
            _logger.debug("SearchKindergartensByCloseTimeAgent get answer: " +
