...
class SearchKindergartensByCloseTimeAgent(ScAgentClassic):
    def __init__(self):
        super().__init__("action_get_kindergartens_by_close_time")
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        self.logger.debug("SearchKindergartensByCloseTimeAgent starts")

        try:
            self.logger.debug("SearchKindergartensByCloseTimeAgent get arguments")
            ...
            self.logger.debug("SearchKindergartensByCloseTimeAgent ends")
    ...
    def find_kindergarten(self, kindergarten_close_time: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            self.logger.debug("SearchKindergartensByCloseTimeAgent get answer: " +
