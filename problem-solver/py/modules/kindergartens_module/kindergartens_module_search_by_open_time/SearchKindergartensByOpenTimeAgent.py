...
class SearchKindergartensByOpenTimeAgent(ScAgentClassic):
    ...
    def on_event(self, class_node: ScAddr, edge: ScAddr, action_node: ScAddr) -> ScResult:
        ...
        status = ScResult.OK
        _logger.debug("SearchKindergartensByOpenTimeAgent starts")

        try:
            _logger.debug("SearchKindergartensByOpenTimeAgent get arguments")
            ...
            _logger.debug("SearchKindergartensByOpenTimeAgent ends")
    ...
    def find_kindergarten(self, kindergarten_open_time: ScAddr, answer_node: ScAddr) -> None:
        ...
        for item in result:
            _logger.debug("SearchKindergartensByOpenTimeAgent get answer: " +
