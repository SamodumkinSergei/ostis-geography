...
class GetUniversitiesByPhoneNumberAgent(ScAgent):
    ...
    def RunImpl(self, evt: ScEventParams) -> ScResult:
        ...
        if self.module.ctx.HelperCheckEdge(
                self.keynodes['action_get_univerisites_by_phone_number'],
                self.main_node,
            ...
            try:
                ...
                phoneIterator = self.ctx.Iterator5(
                    ScType.Unknown,
                    ScType.EdgeDCommon,
                    node,
                    ScType.EdgeAccessConstPosPerm,
                ...
                while phoneIterator.Next():
                    for i in range(5):
                        self.add_nodes_to_answer(answerNode, [phoneIterator.Get(i)])
