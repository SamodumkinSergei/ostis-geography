...
ScAddr village1 = IteratorUtils::getFirstByOutRelation(
        &m_memoryCtx,
        actionNode,
        scAgentsCommon::CoreKeynodes::rrel_1); 

ScAddr village2 = IteratorUtils::getFirstByOutRelation(
        &m_memoryCtx,
        actionNode,
...
ScIterator5Ptr it = ms_context->Iterator5(village1, ScType::EdgeDCommonConst,ScType::Unknown, ScType::EdgeAccessConstPosPerm,Keynodes::nrel_population);
int l1=0;
while (it->Next())
{
ScAddr len = it->Get(2);
...
ScIterator5Ptr it1 = ms_context->Iterator5(village2, ScType::EdgeDCommonConst,ScType::Unknown, ScType::EdgeAccessConstPosPerm,Keynodes::nrel_population);
int l2=0;
while (it1->Next())
{
