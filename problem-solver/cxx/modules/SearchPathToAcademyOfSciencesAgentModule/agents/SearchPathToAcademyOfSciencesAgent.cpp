...
#include "SearchPathToAcademyOfSciencesAgent.hpp"
...
SC_AGENT_IMPLEMENTATION(SearchPathToAcademyOfSciencesAgent)
{
  if (!edgeAddr.IsValid())
    return SC_RESULT_ERROR;

  SC_LOG_INFO("SearchPathToAcademyOfSciencesAgent begin");
  ...
  SC_LOG_INFO("SearchPathToAcademyOfSciencesAgent end");
  return SC_RESULT_OK;
}

void SearchPathToAcademyOfSciencesAgent::findMinimalPath(
    ScAddr currentNode,
    ScAddr target,
    int currentLength,
    int& resultLength,
...
std::list<ScAddr> SearchPathToAcademyOfSciencesAgent::getAllIncidentNodes(const ScAddr& node)
{
...
std::list<ScAddr> SearchPathToAcademyOfSciencesAgent::getIdentifierMeta(const ScAddr& addr)
{
...
int SearchPathToAcademyOfSciencesAgent::getTimeCost(ScAddr edge)
{
  auto timeNode = getTimeNode(edge);
...
ScAddr SearchPathToAcademyOfSciencesAgent::getTimeNode(const ScAddr& edge)
{
...
ScAddr SearchPathToAcademyOfSciencesAgent::getEdgeBetween(const ScAddr& from, const ScAddr& to, ScType type, bool findReverse)
{
