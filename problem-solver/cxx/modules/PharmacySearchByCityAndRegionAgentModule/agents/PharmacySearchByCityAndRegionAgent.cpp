...
SC_AGENT_IMPLEMENTATION(PharmacySearchByCityAndRegionAgent)
{
  ...
  ScIterator5Ptr it1 = ms_context->Iterator5(
      ScType::Unknown, ScType::EdgeDCommonConst, pharmacy, ScType::EdgeAccessConstPosPerm, Keynodes::nrel_city);
  ScAddr pharmacy1;
  ...
  if (it1->Next())
  {
    ...
    ScIterator5Ptr it2 = ms_context->Iterator5(
        pharmacy, ScType::EdgeDCommonConst, ScType::Unknown, ScType::EdgeAccessConstPosPerm, Keynodes::nrel_region);
    if (it2->Next())
    {
