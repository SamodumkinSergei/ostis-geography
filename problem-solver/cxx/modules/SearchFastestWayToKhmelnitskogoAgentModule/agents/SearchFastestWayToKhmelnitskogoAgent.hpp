...
#include "SearchFastestWayToKhmelnitskogoAgent.generated.hpp"

namespace SearchFastestWayToKhmelnitskogoAgentModule
{

class SearchFastestWayToKhmelnitskogoAgent : public ScAgent
{
  SC_CLASS(Agent, Event(Keynodes::action_search_fastest_way_to_Khmelnitskogo, ScEvent::Type::AddOutputEdge))
  SC_GENERATED_BODY()
