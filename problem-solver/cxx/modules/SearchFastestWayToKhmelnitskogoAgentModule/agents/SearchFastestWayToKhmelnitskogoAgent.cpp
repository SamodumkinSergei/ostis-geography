...
#include "SearchFastestWayToKhmelnitskogoAgent.hpp"
#include "keynodes/keynodes.hpp"

using namespace std;
using namespace utils;

namespace SearchFastestWayToKhmelnitskogoAgent
{

SC_AGENT_IMPLEMENTATION(SearchFastestWayToKhmelnitskogoAgent)
{
  if (!edgeAddr.IsValid())
    return SC_RESULT_ERROR;

  SC_LOG_INFO("SearchFastestWayToKhmelnitskogoAgent begin");
  ...
  SC_LOG_INFO("SearchFastestWayToKhmelnitskogoAgent end");
  return SC_RESULT_OK;
}

void SearchFastestWayToKhmelnitskogoAgent::findFastestWay(
    ScAddr currentNode,
    ScAddr target,
    int currentLength,
    int& resultLength,
...
std::list<ScAddr> SearchFastestWayToKhmelnitskogoAgent::getAllIncidentNodes(const ScAddr& node)
{
...
std::list<ScAddr> SearchFastestWayToKhmelnitskogoAgent::getIdentifierMeta(const ScAddr& addr)
{
...
int SearchFastestWayToKhmelnitskogoAgent::getValue(ScAddr edge)
{
...
ScAddr SearchFastestWayToKhmelnitskogoAgent::getNode(const ScAddr& edge)
{
...
ScAddr SearchFastestWayToKhmelnitskogoAgent::getEdgeBetween(const ScAddr& from, const ScAddr& to, ScType type, bool findReverse)
{
