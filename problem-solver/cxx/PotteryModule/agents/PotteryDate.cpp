...
ScAddr date1 = IteratorUtils::getFirstByOutRelation(
        &m_memoryCtx,
        actionNode,
        scAgentsCommon::CoreKeynodes::rrel_1); 

ScAddr date2 = IteratorUtils::getFirstByOutRelation(
        &m_memoryCtx,
        actionNode,
...
{
smth = it2->Get(2);
ScIterator5Ptr it1 = ms_context->Iterator5(smth, ScType::EdgeDCommonConst,ScType::Unknown, ScType::EdgeAccessConstPosPerm,Keynodes::nrel_date);
ScAddr date;
while (it1->Next())
{
date = it1->Get(2);
