module.exports = function(grunt) {
    ...
    var hotelsDirPath = 'components/hotels_ui/';
    ...
    grunt.initConfig({
        concat: {
            ...
            hotelsSection: {
                src: [hotelsDirPath + 'src/hotels-common.js',
                    hotelsDirPath + 'src/hotels-component.js',
                    hotelsDirPath + 'src/hotels-paintPanel.js'
                ],
                dest: hotelsDirPath + 'static/components/js/hotels_ui/hotels.js'
            },
        },
        copy: {
            githubJs: {
            ...
            hotelsJs: {
                cwd: hotelsDirPath + 'static/components/js/hotels_ui/',
                src: 'hotels.js',
                dest: clientJsDirPath + 'hotels_ui/',
                expand: true,
                flatten: true
            },
            githubCss: {
        ...
        watch: {
            ...
            hotelsJs: {
                files: hotelsDirPath + 'src/**',
                tasks: ['concat:hotelsSection', 'copy:hotelsJs'],
            },
            githubCss: {
